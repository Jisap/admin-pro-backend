...
const fileUpload = ( req, res = response ) => {
    ...
    const file = req.files.imagen;                                       // Atrapamos el file
    const nombreCortado = file.name.split('.');                          // Cortamos el nombre según el '.'
    const extensionArchivo = nombreCortado[ nombreCortado.length - 1 ];  // Definimos la extensión
